...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:my-sql-server-docker.database.windows.net,1433;Database=sql-db-docker;Uid=.....;Pwd=.....;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
